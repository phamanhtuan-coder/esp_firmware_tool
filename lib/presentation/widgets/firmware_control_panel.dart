                        ...
                        builder: (context, state) {
                          ...
                          return Padding(
                                    ...
                                    Expanded(
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          if (!hasLocalFile && widget.selectedFirmwareVersion == null)
                                            const Padding(
                            ...
                            Column(
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: [
                                const SizedBox(height: 24), // Height of label + some spacing
                                     _buildLoadingButton(
                                ...
                                Row(
                                  ...
                                  children: [
                                    ...
                                    const SizedBox(width: 8),
                                    Padding(
                                      padding: const EdgeInsets.only(top: 24), // Add top padding to align with input field
                                              ...
                                              border: OutlineInputBorder(
                                                ...
                                                borderSide: BorderSide(
                                                  color: _serialErrorText != null
                                                    ...
                                                    : _serialSuccessText != null
                                                      ? Colors.green
                                                      : widget.isDarkTheme ? Colors.grey : Colors.black12,
                                                  width: 1.0,
                                                ),
                                              ),
